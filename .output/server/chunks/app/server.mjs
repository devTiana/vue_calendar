...
const _routes = [
  {
    ...
    file: "/Users/sohun/Documents/GitHub/Interview_practice/m3sen_test_calendar/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.f91f6a44.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.479205de.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
